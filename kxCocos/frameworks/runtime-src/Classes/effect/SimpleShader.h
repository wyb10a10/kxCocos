...
public:
    ...
    // h s v 为增加量和减少量
    static cocos2d::GLProgramState* applyHSVShaderNoMVP(cocos2d::Node* node, const cocos2d::Vec3& hsv);

    // 设置色相
    static cocos2d::GLProgramState* applyHueShader(cocos2d::Node* node, const float hue);
	static cocos2d::GLProgramState* applyHueShaderNoMVP(cocos2d::Node* node, const float hue);
