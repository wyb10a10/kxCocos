#ifndef _KXCOCOS_LUA_TOOLS_
#define _KXCOCOS_LUA_TOOLS_
...
namespace LuaTools
{
    ...
    void getStructShortValueByKey(lua_State* luaState, const char* key, short& value);
    void getStructCharValueByKey(lua_State* luaState, const char* key, char& value);
