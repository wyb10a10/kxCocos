...
{
    CFMODAudioEngine* fmod = LuaTools::checkClass<CFMODAudioEngine>(l, -2, "KxCocos.FMODAudioEngine");
...
int playEffect(lua_State* l)
{
    ...
    {
        CFMODAudioEngine* fmod = LuaTools::checkClass<CFMODAudioEngine>(l, -3, "KxCocos.FMODAudioEngine");
...
{
    CFMODAudioEngine* fmod = LuaTools::checkClass<CFMODAudioEngine>(l, -1, "KxCocos.FMODAudioEngine");
...
int unloadBank(lua_State* l)
{
    ...
    lua_pushboolean(l, fmod->unloadBankFile(bankFile));
...
{
    LuaTools::pushClass(l, CFMODAudioEngine::getInstance(), "KxCocos.FMODAudioEngine");
    return 1;
}
...
bool registeFMODAudioEngine()
{
    ...
    luaL_newmetatable(luaState, "KxCocos.FMODAudioEngine");
