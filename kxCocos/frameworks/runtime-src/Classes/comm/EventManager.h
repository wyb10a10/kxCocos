...
typedef void (cocos2d::Ref::*CallBackV)(void*);

class EventCallBack
{
public:
    EventCallBack(cocos2d::Ref* ref, CallBackV fun, EventList* owner)
        :Target(ref),
        Func(fun),
        Owner(owner)
    {
    ...
    void init(cocos2d::Ref* ref, CallBackV fun, EventList* owner)
    {
        SAFE_RELEASE(Target);
        Target = ref;
        SAFE_RETAIN(Target);
    ...
    bool compare(cocos2d::Ref* ref, CallBackV fun)
    {
