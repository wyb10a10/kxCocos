...
Sprite* cloneSprite(Sprite* sp)
{
    ...
    newSprite->setCascadeColorEnabled(sp->isCascadeColorEnabled());
    newSprite->setCascadeOpacityEnabled(sp->isCascadeOpacityEnabled());
...
Node* CsbTool::cloneCsbNode(Node* node)
{
    ...
    newNode->setCascadeColorEnabled(node->isCascadeColorEnabled());
    newNode->setCascadeOpacityEnabled(node->isCascadeOpacityEnabled());
