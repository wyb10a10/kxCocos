...
function ScrollViewExtend:init(tabParam)
    ...
    self.BlankSpace = tabParam.blankSpace or 0          -- 留空区域的长度,根据滚动方向设置
...
-- 获取节点表
function ScrollViewExtend:getCellTable()
    return self.cellTable
end

-- 设置滚动区域大小
function ScrollViewExtend:setScrollViewInnerSize(Size)
    self.innerSize = Size
end
